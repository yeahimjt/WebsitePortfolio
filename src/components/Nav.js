...
const Nav = () => {
  ...
  return (
    <nav className={theme==="light"?"rounded-full fixed font-paragraph text-sm top-0 m-2 mobile:m-4 bg-[color:var(--black-lightest)] text-white border-2 right-0 flex gap-6 px-8 py-3 items-center justify-center mobile:w-[400px] select-none z-50":"rounded-full fixed font-paragraph text-sm top-0 right-0 m-2  mobile:m-4 bg-[color:var(--white-lightest)] text-black border-2 flex gap-6 px-8 py-3 items-center justify-center mobile:w-[400px] select-none z-50"}>
        ...
        <a  className="hover:scale-105 hover:text-[color:var(--cyan)] hidden mobile:block" href="#projects">Projects</a>
        <a  className="hover:scale-105 hover:text-[color:var(--cyan)] hidden mobile:block" href="#profile">Profile</a>
        <a  className="hover:scale-105 hover:text-[color:var(--cyan)] hidden mobile:block" href="#contact">Contact</a>
    </nav>
  )
}
