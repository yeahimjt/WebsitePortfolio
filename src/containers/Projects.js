...
import { SiAmazonaws, SiBootstrap, SiCss3, SiExpress, SiFlask, SiGit, SiHtml5, SiMongodb, SiNetlify, SiPython, SiReact, SiRender, SiTailwindcss } from 'react-icons/si'
            ...
            <div ref={myRef1} className={`${theme==="light"?"flex gap-x-6 ":"flex gap-x-6 text-white"}`}>
                ...
                <div className={`${"flex-[0.5] overflow-hidden opacity-0"} ${myElementIsVisible1 ? 'animate-slideright' : ''}`}>
                    ...
                    <div className="flex justify-center items-center gap-6 pt-4 pb-2">
                        <a className="w-[25%] border-2 border-[color:var(--blue)] rounded-xl py-1 hover:cursor-pointer hover:scale-105 transition-all text-center" href="https://github.com/yeahimjt/centraltech-react" target="_blank" rel="noreferrer">View Code</a>
                        <a className="bg-test w-[25%] py-1 rounded-xl hover:cursor-pointer hover:scale-105 transition-all text-white text-center" href="https://effortless-froyo-17f9a2.netlify.app/" target="_blank" rel="noreferrer">View Live</a>
                    </div>
            ...
            <div ref={myRef2} className={`${theme==="light"?"flex gap-x-6 mt-64 ":"flex gap-x-6 text-white mt-64"}`}>
              <div className="flex-[0.50] flex items-center justify-center overflow-visible relative">
                ...
                <div className={`${"flex-[0.5] overflow-hidden"} ${myElementIsVisible2 ? 'animate-slideright' : ''}`}>
                    ...
                    <div className="flex justify-center items-center gap-6 pt-4 pb-2">
                        <a className="bg-test w-[25%] py-1 rounded-xl hover:cursor-pointer hover:scale-105 transition-all text-white text-center" href="http://www.nerd4u.online/" target="_blank" rel="noreferrer">View Live</a>
                        <a className="w-[25%] border-2 border-[color:var(--blue)] rounded-xl py-1 hover:cursor-pointer hover:scale-105 transition-all text-center" href="https://github.com/yeahimjt/Nerd4U-Ecommerce" target="_blank" rel="noreferrer">View Code</a>
                    </div>
