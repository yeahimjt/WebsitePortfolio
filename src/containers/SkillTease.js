...
const SkillTease = () => {
  ...
  return (
    <div className={theme==="light"? "max-w-[1158px] flex justify-center bg-[color:var(--skill-tease)] w-full  absolute bottom-8 py-8 items-center flex-wrap z-40 gap-8 gap-y-2" : "max-w-[1158px] flex justify-center bg-[color:var(--skill-tease-dark)] w-full  absolute bottom-8 py-8 items-center flex-wrap z-40 gap-8 gap-y-2"}>
